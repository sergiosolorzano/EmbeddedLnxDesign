...
DEFAULT_LINUX_KERNEL_VERSION="5.15.93"
USER_SELECTED_LINUX_KERNEL_VERSION=""
LINUX_KERNEL_GIT_REPO="https://cdn.kernel.org/pub/linux/kernel/v5.x/linux-"
...
if [[ -z "$USER_SELECTED_LINUX_KERNEL_VERSION" ]] ; then 
  ...
  echo " "; echo  "Example: Use ./$THIS_SCRIPT_NAME -v 5.15.93"
